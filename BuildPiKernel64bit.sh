...
SOURCE_IMG="ubuntu-$SOURCE_RELEASE-preinstalled-server-arm64+raspi4.img"
SOURCE_IMGXZ="ubuntu-$SOURCE_RELEASE-preinstalled-server-arm64+raspi4.img.xz"
RASPBIAN_IMG="2020-05-27-raspbian-buster-lite.img"
RASPBIAN_IMGZIP="2020-05-27-raspbian-buster-lite.img.zip"
